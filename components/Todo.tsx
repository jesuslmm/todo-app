...
export const Todo: React.FC<Itodo> = ({
  ...
  return (
    <li
      key={data.id}
      className="flex gap-40 rounded-md border-2 bg-gray-100 border-gray-100 px-8 py-2.5 mb-2 text-slate-700 font-mono text-xl font-extralight hover:bg-gray-200"
    >
      <div>
        <input
